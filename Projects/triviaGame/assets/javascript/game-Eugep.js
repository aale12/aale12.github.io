...
function setNextQuestion() {
    ...
    for (i = 0; i < 4; i++) {
        $("#answers").append("<input type='radio' value = " + value[i] + " name=" + questionObj[currentQuestion].name + "><label for =" + questionObj[currentQuestion].choices[i] + ">" + questionObj[currentQuestion].choices[i] + "</label><br/>");
    }
    currentQuestion++;
}
...
$("#submitButton").on("click", function () {
    ...
    playerGuess = $("input[type='radio']").val();
